...
def ascii_art(tail_char, eye_char, paper_rows, clock_frame):
    art_height = 31
    art_width = 150
    ...
    for row in range(art_height):
        ...
        for col in range(art_width):  
            if row in paper_rows and 101 <= col <= 114:
                line += "@"
            elif row == 0:
                ...
                if col == 32 or col == 70 or col == 73 or col == 85:
                    ...
                    line += "/"
                elif col == 136 and clock_frame == 1:
                    line += "\\"
                elif col == 138:
                    line += "1"
                elif col == 139:
                    line += "2"
                elif col == 142 and clock_frame == 3:
                    line += "/"
                ...
                if col == 32 or col == 70 or col == 73 or col == 85:
                    ...
                    line += "."
                elif col == 133 or col == 134 or col ==139 or col == 143 or col == 144:
                    line += "|"
                elif col == 137 and clock_frame == 1:
                    line += "\\"
                elif col == 138 and clock_frame == 2:
                    line += "|"
                elif col == 141 and clock_frame == 3:
                    line += "/"
                ...
                elif col == 138 and clock_frame == 7:
                    line += "/"
                elif col == 138 and clock_frame == 2:
                    line += "|"
                elif col == 138 and clock_frame == 1:
                    line += "\\"
                elif col == 139:
                    line += "|"
                elif col == 140 and clock_frame == 3:
                    line += "/"
                elif col == 140 and clock_frame == 5:
                    line += "\\"
                elif col == 140 and clock_frame == 4:
                    line += "-"
                elif 137 <= col <= 138 and clock_frame == 8:
                    line += "-"
                ...
                if col == 32 or col == 70 or col == 73 or col == 85:
                    ...
                    line += "|"
                elif col == 141 and clock_frame == 5:
                    line += "\\"
                elif col == 139 and clock_frame == 6:
                    line += "|"
                elif col == 137 and clock_frame == 7:
                    line += "/"
                ...
                if col == 32 or col == 70 or col == 73 or col == 85:
                    ...
                    line += "6"
                elif col == 142 and clock_frame == 5:
                    line += "\\"
                elif col == 136 and clock_frame == 7:
                    line += "/"
...
clock_frames = [1, 2, 3, 4, 5, 6, 7, 8]
clock_index = 0

while True:
    for paper_rows in paper_sequences:
        os.system('cls' if os.name == 'nt' else 'clear')
        ascii_art(tail_chars[tail_index], eye_chars[eye_index], paper_rows, clock_frames[clock_index])
        time.sleep(0.5)
        # Update tail, eye, and clock characters
        tail_index = (tail_index + 1) % len(tail_chars)
        eye_index = (eye_index + 1) % len(eye_chars)
        clock_index = (clock_index + 1) % len(clock_frames)
